...
public class NthHighestSalaryDemo {
        ...
        public static void main(String[] args) {
                ...
                Map<String, Integer> sortedMap = map2.entrySet()
                        .stream()
                ...
                System.out.println("Sorted map 1  ::    " + map1.entrySet().stream()
                        .sorted(Collections.reverseOrder(Map.Entry.comparingByValue()))
                        .toList());
                System.out.println("Sorted map 2  ::   " + sortedMap);
                System.out.println("getNthHighestSalary ::  " + getNthHighestSalary(2, map2));


                System.out.println(" getDynamicNthHighestSalary ::  " + getDynamicNthHighestSalary(3, map1));
